...
enum class DirectionsIncludingDiagonal(val deg: Int) {
	N(0), W(270), S(180), O(90), NW(315), NO(45), SO(135), SW(225);
	...
	fun rotate(degree: Int = 90) = Dir.entries.first { (this.deg + degree) % 360 == it.deg }
}
